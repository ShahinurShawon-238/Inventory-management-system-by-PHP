...
<body id="adminMenu">
        <div class="container">
            ...
            <div class="text-center">
                <h1 class="menuTxt">Our Shop-Point Of Sell</h1>
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="point_of_sell.php">POS<span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="container adminmenuRowContainer">
                ...
                <div class="box1">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <form action="point_of_sell.php" method="post" class="needs-validation" novalidate>
                                <div class="form-row">
                                    <div class="col">
